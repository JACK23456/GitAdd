...
<div id="e">
  ...
  <a href="${ pageContext.request.contextPath}/index.jsp">退出登录</a>
     ...
     <form action="${pageContext.request.contextPath }/changediato" method="post" class="mybody" id="form">
     <label>时间</label>
     ...
     <br>
     <label>事情</label>
     <input type="text" name="accident" value=${accident }>
     <br>
     <input type="text" name="diaid" value="${diaid }" style="display:none">
